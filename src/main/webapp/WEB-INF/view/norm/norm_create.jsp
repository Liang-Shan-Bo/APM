			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							服务指标<small> <i class="icon-double-angle-right"></i> 添加
							</small>
						</h1>
					</div>
					<!-- 添加指标 -->
					<div class="row">
						<div class="col-xs-12">
							<form id="createForm" class="form-horizontal" role="form" action="<%=path%>/createNorm" method="post">
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="normName"> 指标名称 </label>
									<div class="col-sm-9">
										<input type="text" id="normName" class="col-xs-10 col-sm-4" name="normName"/>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="normNormal"> 正常内存负载(M) </label>
									<div class="col-sm-9">
										<input type="text" id="normNormal" class="col-xs-10 col-sm-4" name="normNormal"/>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="normWarning"> 警告内存负载(M) </label>
									<div class="col-sm-9">
										<input type="text" id="normWarning" class="col-xs-10 col-sm-4" name="normWarning"/>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="normDanger"> 过高内存负载 (M)</label>
									<div class="col-sm-9">
										<input type="text" id="normDanger" class="col-xs-10 col-sm-4" name="normDanger"/>
									</div>
								</div>
			...
			rules : {
				normName : {
					...
					remote:{
			               type:"get",
			               url:"<%=path%>/checkName",           
			               data:{ normName: function() { return $("#normName").val(); }} 
					}
				},
				normNormal : {
					required : true,
